...
int gpio_test(int portNumber){

    int gpio_pin = portNumber;
    ...
    std::cout << "int port function: "<< "name" << std::endl;

    return 0;
}


int gpio_port_direction(int gpio_pin, int read_write){

    gpio_export(gpio_pin);
    gpio_direction(gpio_pin, read_write);

    return 0;
}

int gpio_port_toggle(int gpio_pin, int on_off){

    gpio_write(gpio_pin, on_off);
    return 0;
}

int main()
{
    std::cout << "Hello IoT2000! \n" << std::endl;
